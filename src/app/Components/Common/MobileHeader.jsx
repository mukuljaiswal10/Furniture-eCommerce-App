...
//               }`}
//             >
//               <li className="py-2"><Link href={"/about-us"}>About</Link></li>
//               <li className="py-2"><Link href={"/contact-us"}>Contact</Link></li>
//               <li className="py-2">FAQ</li>
//             </ul>
//           </li>

//           {/* LOGIN */}
//           <li className="py-4 cursor-pointer"><Link href={"/login-register"}>Login / Register</Link></li>
//         </ul>
//       </div>
//     </>
//   );
...
export default function MobileHeader() {
  ...
  /* ✅ Route change होते ही menu close (professional) */
  useEffect(() => {
    setOpenMenu(false);
  ...
  return (
    <>
      ...
      <div className="lg:hidden bg-[white] px-4 py-3 flex gap-2 items-center justify-between border-b sticky top-0 z-40">
        ...
        <div className="flex items-center gap-4">
          {/* Wishlist */}
          <div className="border border-[#d2d1d1] px-3 py-2 rounded-md group cursor-pointer">
            <FaHeart className="group-hover:text-[#C09578] duration-[1s]" />
          </div>

          {/* Cart */}
          <div className="relative flex items-center gap-2 border border-[#d2d1d1] px-4 py-2 rounded-md group cursor-pointer">
            <span
              className="absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2
              bg-[#c1a27a] text-white text-[10px]
              w-4 h-4 flex items-center justify-center rounded-full"
          ...
          {/* Hamburger */}
          <button
            className="border border-[#d2d1d1] px-3 py-2 rounded-md cursor-pointer"
            onClick={() => setOpenMenu(true)}
          >
            <FaBars />
          </button>
      ...
      >
        ...
        <div className="relative px-4 py-6 border-b text-center">
          ...
          <button
            onClick={() => setOpenMenu(false)}
            className="absolute top-4 right-4 text-xl z-[60] border bg-white cursor-pointer"
          >
            <FaTimes size={18} />
          </button>
        ...
        <ul className="px-4 text-[15px]">
          ...
          <li className="border-b">
            <button
              onClick={() => toggleDropdown("living")}
              className={`cursor-pointer w-full flex justify-between items-center py-4 ${
                active === "living" ? "text-[#c1a27a] font-medium" : ""
              }`}
            >
              Living
            ...
            >
              <li className="py-2 cursor-pointer">Tables</li>
              <li className="py-2 cursor-pointer">Mirror</li>
          ...
          <li className="border-b">
            ...
            >
              <li className="py-2 cursor-pointer">3 Seater Sofa</li>
              <li className="py-2 cursor-pointer">2 Seater Sofa</li>
              <li className="py-2 cursor-pointer">Sofa Cum Bed</li>
            </ul>
          </li>
